...
- [uppdatering 2026-08-27] De två följdfynd raden ovan säger inte kunde filas ÄR nu filade, sedan Malin öppnat platser i Linear: BIN-1035 (BIN-996 alternativ 3, grindens blockmeddelande) och BIN-1036 (`preview-gate.mjs` utan tester — BIN-1009 stängde `freshness.mjs`-halvan och vidgade globarna, så bara den ena delen återstod). Raderna nedan står kvar ordagrant; de beskrev läget när de skrevs.

...
export default function DiscoverPageClient({
  ...
  // Build-time-seedade trendande titlar (server page.tsx) så exportens
  // statiska HTML får crawlbara titellänkar. Live trending ersätter seeden
  // så fort klient-fetchen löst.
  ...
  const trendingBase = trending?.results ?? initialTrending ?? [];

...
import { MAX_PAGES } from './motnChanges';
...
// never actually tracked the real constants. Both are now live-imported from
// ./config.ts (admin-free, split out of index.ts specifically for this).
